...
const routes = [{
    ...
    children: [{
        ...
        },
        {
            ...
            component: () =>
                import ('@cruds/Companies/Index.vue'),
        ...
        },
        {
            ...
            component: () =>
                import ('@cruds/Companies/Create.vue'),
            meta: { title: 'cruds.company.title' }
        },
        {
            path: 'companies/:id',
            name: 'companies.show',
            component: () =>
                import ('@cruds/Companies/Show.vue'),
            meta: { title: 'cruds.company.title' }
        },
        {
            ...
            name: 'companies.edit',
            component: () =>
                import ('@cruds/Companies/Edit.vue'),
            meta: { title: 'cruds.company.title' }
        },
        {
            path: 'employees',
            ...
            component: () =>
                import ('@cruds/Employees/Index.vue'),
            meta: { title: 'cruds.employee.title' }
        },
        {
            path: 'employees/create',
            name: 'employees.create',
            component: () =>
                import ('@cruds/Employees/Create.vue'),
            meta: { title: 'cruds.employee.title' }
        },
        {
            path: 'employees/:id',
            name: 'employees.show',
            component: () =>
                import ('@cruds/Employees/Show.vue'),
            meta: { title: 'cruds.employee.title' }
        },
        {
            ...
            name: 'employees.edit',
            component: () =>
                import ('@cruds/Employees/Edit.vue'),
            meta: { title: 'cruds.employee.title' }
        }
    ]
}]
